...
$("body").on("loaded.bs.select change", "select.ajax-search", function(e) {
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function() {
        ...
        }), init_table_tickets(),init_table_meter_number(),init_table_full_report(),init_table_network_report(),init_table_trafic_road_safety_report(),init_table_paycity_report(),init_table_paycitySLA_report(),init_table_trafic_road_safetySLA_report(),init_table_networkSLA_report(),init_table_full_reportSLA_report(), init_table_announcements(), init_table_staff_projects(), (table_activity_log = $("table.table-activity-log")).length) {
        var p = [];
