        ...
        return $.post(this.action, $(this).serialize()).done(function (e) {
            if ((e = JSON.parse(e)).postid) {
                if (newsFeedDropzone.getQueuedFiles().length > 0)
                    return newsFeedDropzone.options.url = admin_url + "newsfeed/add_post_attachments/" + e.postid, void newsFeedDropzone.processQueue();
...
function leads_bulk_action(e) {
    if (confirm_delete()) {
        var t = $("#mass_delete").prop("checked"),
                ...
                i = {};
        if (0 == t || void 0 === t) {
            if (i.lost = $("#leads_bulk_mark_lost").prop("checked"), i.status = $("#move_to_status_leads_bulk").val(), i.assigned = $("#assign_to_leads_bulk").val(), i.source = $("#move_to_source_leads_bulk").val(), i.last_contact = $("#leads_bulk_last_contact").val(), i.tags = $("#tags_bulk").tagit("assignedTags"), i.visibility = $('input[name="leads_bulk_visibility"]:checked').val(), i.assigned = void 0 === i.assigned ? "" : i.assigned, i.visibility = void 0 === i.visibility ? "" : i.visibility, "" === i.status && !1 === i.lost && "" === i.assigned && "" === i.source && "" === i.last_contact && 0 == i.tags.length && "" === i.visibility)
                return
        } else
            i.mass_delete = !0;
...
function init_table_full_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-full_report").length) {
        var t = {},
                a = $("._hidden_inputs._filters._full_report_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        });
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-full_report", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_network_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-network").length) {
        var t = {},
                a = $("._hidden_inputs._filters._network_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-network", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_trafic_road_safety_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-trafic_road_safety").length) {
        var t = {},
                a = $("._hidden_inputs._filters._trafic_road_safety_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-trafic_road_safety", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_paycity_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-paycity").length) {
        var t = {},
                a = $("._hidden_inputs._filters._paycity_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-paycity", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_paycitySLA_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-paycitySLA").length) {
        var t = {},
                a = $("._hidden_inputs._filters._paycitySLA_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-paycitySLA", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_trafic_road_safetySLA_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-trafic_road_safetySLA").length) {
        var t = {},
                a = $("._hidden_inputs._filters._trafic_road_safetySLA_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-trafic_road_safetySLA", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_networkSLA_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-networkSLA").length) {
        var t = {},
                a = $("._hidden_inputs._filters._networkSLA_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-networkSLA", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_full_reportSLA_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-full_reportSLA").length) {
        var t = {},
                a = $("._hidden_inputs._filters._full_reportSLA_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-full_reportSLA", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_unassigned_companies_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-unassigned_companies").length) {
        var t = {},
                a = $("._hidden_inputs._filters._unassigned_companies_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "ems_report/table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-unassigned_companies", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_pmd_report(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-ticket")))
        return !1;
    if (0 !== $("body").find(".table-pmd_report").length) {
        var t = {},
                a = $("._hidden_inputs._filters._pmd_report_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "reports/pmd_report_table";
        if ($("body").hasClass("stocks") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-pmd_report", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function init_table_meter_number(e) {
    if (void 0 === e && ($("body").hasClass("dashboard") || $("body").hasClass("single-meter_number")))
        return !1;
    if (0 !== $("body").find(".table-meter_number").length) {
        var t = {},
                a = $("._hidden_inputs._filters._meter_number_filters input"),
                //i = $("table.table-stocks thead .stock_m_date").index();
                i = 1;
        $.each(a, function () {
            t[$(this).attr("name")] = '[name="' + $(this).attr("name") + '"]'
        ...
        var n = [0],
                s = admin_url + "meter_number/table";
        if ($("body").hasClass("meter_number") && (s += "?bulk_actions=true"), _table_api = initDataTable(".table-meter_number", s, n, n, t, [i, "desc"]), _table_api && $("body").hasClass("dashboard")) {
            var o = [4, i, 5, 6];
            for (var l in o)
                _table_api.column(o[l]).visible(!1, !1);
            _table_api.columns.adjust()
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length,
            ...
            a = 0,
            i = $(".task-progress-bar");
    if (0 == t ? ($("body").find(".chk-heading").remove(), $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"), !(t > 2))
        return i.parents(".progress").addClass("hide"), !1;
...
function add_task_root_cause(e) {
    var t = {};
    taskRootCauseAttachmentDropzone.files.length > 0 ? taskRootCauseAttachmentDropzone.processQueue(e) : (tinymce.activeEditor ? t.content = tinyMCE.activeEditor.getContent() : (t.content = $("#task_root_cause").val(), t.no_editor = !0), t.taskid = e, $.post(admin_url + "tasks/add_task_root_cause", t).done(function (e) {
        _task_append_html((e = JSON.parse(e)).taskHtml), tinymce.remove("#task_root_cause")
    }))
}

function add_task_corrective_action(e) {
    var t = {};
    taskCorrectiveActionAttachmentDropzone.files.length > 0 ? taskCorrectiveActionAttachmentDropzone.processQueue(e) : (tinymce.activeEditor ? t.content = tinyMCE.activeEditor.getContent() : (t.content = $("#task_corrective_action").val(), t.no_editor = !0), t.taskid = e, $.post(admin_url + "tasks/add_task_corrective_action", t).done(function (e) {
        _task_append_html((e = JSON.parse(e)).taskHtml), tinymce.remove("#task_corrective_action")
    }))
}

function add_task_preventive_action(e) {
    var t = {};
    taskPreventiveActionAttachmentDropzone.files.length > 0 ? taskPreventiveActionAttachmentDropzone.processQueue(e) : (tinymce.activeEditor ? t.content = tinyMCE.activeEditor.getContent() : (t.content = $("#task_corrective_action").val(), t.no_editor = !0), t.taskid = e, $.post(admin_url + "tasks/add_task_preventive_action", t).done(function (e) {
        _task_append_html((e = JSON.parse(e)).taskHtml), tinymce.remove("#task_preventive_action")
    }))
}
...
function remove_task_root_cause(e) {
    confirm_delete() && requestGetJSON("tasks/remove_root_cause/" + e).done(function (t) {
        !0 !== t.success && "true" != t.success || ($('[data-commentid="' + e + '"]').remove(), $('[data-comment-attachment="' + e + '"]').remove(), _task_attachments_more_and_less_checks())
    })
}

function remove_task_corrective_action(e) {
    confirm_delete() && requestGetJSON("tasks/remove_corrective_action/" + e).done(function (t) {
        !0 !== t.success && "true" != t.success || ($('[data-commentid="' + e + '"]').remove(), $('[data-comment-attachment="' + e + '"]').remove(), _task_attachments_more_and_less_checks())
    })
}

function remove_task_preventive_action(e) {
    confirm_delete() && requestGetJSON("tasks/remove_preventive_action/" + e).done(function (t) {
        !0 !== t.success && "true" != t.success || ($('[data-commentid="' + e + '"]').remove(), $('[data-comment-attachment="' + e + '"]').remove(), _task_attachments_more_and_less_checks())
    })
}
...
function task_form_handler(e) {
    ...
    return $.ajax({
        ...
        if (!0 !== (e = JSON.parse(e)).success && "true" != e.success || alert_float("success", e.message), $("body").hasClass("project")) {
            ...
            $("#_task_modal").attr("data-task-created", !0), $("#_task_modal").modal("hide"), init_task_modal(e.id), reload_tasks_tables(), $("body").hasClass("kan-ban-body") && $("body").hasClass("tasks") && tasks_kanban()
    }).fail(function (e) {
...
function edit_task_root_cause(e) {
    var t = $('[data-edit-root_cause="' + e + '"]');
    if (t.next().addClass("hide"), t.removeClass("hide"), !is_ios()) {
        tinymce.remove("#task_root_cause_" + e);
        var a = _simple_editor_config();
        a.auto_focus = "task_root_cause_" + e, init_editor("#task_root_cause_" + e, a), tinymce.triggerSave()
    }
}

function edit_task_preventive_action(e) {
    var t = $('[data-edit-preventive="' + e + '"]');
    if (t.next().addClass("hide"), t.removeClass("hide"), !is_ios()) {
        tinymce.remove("#task_preventive_" + e);
        var a = _simple_editor_config();
        a.auto_focus = "task_preventive_" + e, init_editor("#task_preventive_" + e, a), tinymce.triggerSave()
    }
}

function edit_task_corrective_action(e) {
    var t = $('[data-edit-corrective="' + e + '"]');
    if (t.next().addClass("hide"), t.removeClass("hide"), !is_ios()) {
        tinymce.remove("#task_corrective_" + e);
        var a = _simple_editor_config();
        a.auto_focus = "task_corrective_" + e, init_editor("#task_corrective_" + e, a), tinymce.triggerSave()
    }
}
...
function cancel_edit_root_cause(e) {
    var t = $('[data-edit-root_cause="' + e + '"]');
    tinymce.remove('[data-edit-root_cause="' + e + '"] textarea'), t.addClass("hide"), t.next().removeClass("hide")
}

function cancel_edit_corrective_action(e) {
    var t = $('[data-edit-corrective="' + e + '"]');
    tinymce.remove('[data-edit-corrective="' + e + '"] textarea'), t.addClass("hide"), t.next().removeClass("hide")
}

function cancel_edit_preventive_action(e) {
    var t = $('[data-edit-preventive="' + e + '"]');
    tinymce.remove('[data-edit-preventive="' + e + '"] textarea'), t.addClass("hide"), t.next().removeClass("hide")
}
...
function save_edited_root_cause(e, t) {
    tinymce.triggerSave();
    var a = {};
    a.id = e, a.task_id = t, a.content = $('[data-edit-root_cause="' + e + '"]').find("textarea").val(), is_ios() && (a.no_editor = !0), $.post(admin_url + "tasks/edit_root_cause", a).done(function (t) {
        !0 === (t = JSON.parse(t)).success || "true" == t.success ? (alert_float("success", t.message), _task_append_html(t.taskHtml)) : cancel_edit_comment(e), tinymce.remove('[data-edit-root_cause="' + e + '"] textarea')
    })
}

function save_edited_corrective_action(e, t) {
    tinymce.triggerSave();
    var a = {};
    a.id = e, a.task_id = t, a.content = $('[data-edit-corrective="' + e + '"]').find("textarea").val(), is_ios() && (a.no_editor = !0), $.post(admin_url + "tasks/edit_corrective_action", a).done(function (t) {
        !0 === (t = JSON.parse(t)).success || "true" == t.success ? (alert_float("success", t.message), _task_append_html(t.taskHtml)) : cancel_edit_comment(e), tinymce.remove('[data-edit-corrective="' + e + '"] textarea')
    })
}

function save_edited_preventive_action(e, t) {
    tinymce.triggerSave();
    var a = {};
    a.id = e, a.task_id = t, a.content = $('[data-edit-preventive="' + e + '"]').find("textarea").val(), is_ios() && (a.no_editor = !0), $.post(admin_url + "tasks/edit_preventive_action", a).done(function (t) {
        !0 === (t = JSON.parse(t)).success || "true" == t.success ? (alert_float("success", t.message), _task_append_html(t.taskHtml)) : cancel_edit_comment(e), tinymce.remove('[data-edit-preventive="' + e + '"] textarea')
    })
}
...
function tasks_bulk_action(e) {
    if (confirm_delete()) {
        ...
        if (0 == i || void 0 === i) {
            ...
            if (a.milestone = o.length ? o.selectpicker("val") : "", a.priority = $("#task_bulk_priority").val(), a.priority = void 0 === a.priority ? "" : a.priority, "" === a.status && "" === a.priority && "" === a.tags && "" === a.assignees && "" === a.milestone)
                return
        } else
            a.mass_delete = !0;
...
function clear_billing_and_shipping_details() {
    for (var e in billingAndShippingFields)
        billingAndShippingFields[e].indexOf("country") > -1 ? $('select[name="' + billingAndShippingFields[e] + '"]').selectpicker("val", "") : ($('input[name="' + billingAndShippingFields[e] + '"]').val(""), $('textarea[name="' + billingAndShippingFields[e] + '"]').val("")), "billing_country" == billingAndShippingFields[e] && ($('input[name="include_shipping"]').prop("checked", !1), $('input[name="include_shipping"]').change());
...
function _set_item_preview_custom_fields_array(e) {
    for (var t = ["input", "number", "date_picker", "date_picker_time", "colorpicker"], a = 0; a < e.length; a++) {
        ...
        if ($.inArray(i.type, t) > -1)
            ...
            empty(i.value) || (n = (n = i.value.split(",")).map(function (e) {
                return e.trim()
        ...
        return get_taxes_dropdown_template(l, e.taxname).done(function (a) {
            ...
            i.length > 0 && $.each(i, function () {
                ...
                if (a.is(":checkbox")) {
                    ...
                    a.is("input") ? e.find("[data-fieldid]").attr("value", a.val()) : e.find("[data-fieldid]").html(a.val()), e.find("[data-fieldid]").attr("name", i), "1" == e.find("[data-fieldid]").attr("data-custom-field-required") && (l = !0), t = e.html();
                else if (a.is("select")) {
...
function init_invoices_total(e) {
    if (0 !== $("#invoices_total").length) {
        ...
        if (!$("body").hasClass("invoices-total-manual") || void 0 !== e || a.hasClass("initialized"))
            if (t.length > 0 && a.hasClass("initialized"))
                t.removeClass("invoices-total-inline");
            else {
...
function init_new_task_root_cause(e) {
    tinymce.editors.task_comment && tinymce.remove("#task_root_cause"), "undefined" != typeof taskRootCauseAttachmentDropzone && taskRootCauseAttachmentDropzone.destroy(), $("#dropzoneTaskRootCause").removeClass("hide"), $("#addTaskRootCauseBtn").removeClass("hide"), taskRootCauseAttachmentDropzone = new Dropzone("#task-root-cause-form", appCreateDropzoneOptions({
        uploadMultiple: !0,
        clickable: "#dropzoneTaskRootCause",
        previewsContainer: ".dropzone-task-root-cause-previews",
        autoProcessQueue: !1,
        addRemoveLinks: !0,
        parallelUploads: 20,
        maxFiles: 20,
        paramName: "file",
        sending: function (e, t, a) {
            a.append("taskid", $("#addTaskRootCauseBtn").attr("data-root-cause-task-id")), tinyMCE.activeEditor ? a.append("content", tinyMCE.activeEditor.getContent()) : a.append("content", $("#task_root_cause").val())
        },
        success: function (e, t) {
            t = JSON.parse(t), 0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (_task_append_html(t.taskHtml), tinymce.remove("#task_root_cause"))
        }
    }));
    var t = _simple_editor_config();
    void 0 !== e && !1 !== e || (t.auto_focus = !0), is_ios() || init_editor("#task_root_cause", t)
}

function init_new_task_corrective_action(e) {
    tinymce.editors.task_comment && tinymce.remove("#task_corrective_action"), "undefined" != typeof taskCorrectiveActionAttachmentDropzone && taskCorrectiveActionAttachmentDropzone.destroy(), $("#dropzoneTaskCorrectiveAction").removeClass("hide"), $("#addTaskCorrectiveActionBtn").removeClass("hide"), taskCorrectiveActionAttachmentDropzone = new Dropzone("#task-corrective-action-form", appCreateDropzoneOptions({
        uploadMultiple: !0,
        clickable: "#dropzoneTaskCorrectiveAction",
        previewsContainer: ".dropzone-task-corrective-action-previews",
        autoProcessQueue: !1,
        addRemoveLinks: !0,
        parallelUploads: 20,
        maxFiles: 20,
        paramName: "file",
        sending: function (e, t, a) {
            a.append("taskid", $("#addTaskCorrectiveActionBtn").attr("data-corrective-task-id")), tinyMCE.activeEditor ? a.append("content", tinyMCE.activeEditor.getContent()) : a.append("content", $("#task_corrective_action").val())
        },
        success: function (e, t) {
            t = JSON.parse(t), 0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (_task_append_html(t.taskHtml), tinymce.remove("#task_corrective_action"))
        }
    }));
    var t = _simple_editor_config();
    void 0 !== e && !1 !== e || (t.auto_focus = !0), is_ios() || init_editor("#task_corrective_action", t)
}

function init_new_task_preventive_action(e) {
    tinymce.editors.task_comment && tinymce.remove("#task_preventive_action"), "undefined" != typeof taskPreventiveActionAttachmentDropzone && taskPreventiveActionAttachmentDropzone.destroy(), $("#dropzoneTaskPreventiveAction").removeClass("hide"), $("#addTaskPreventiveActionBtn").removeClass("hide"), taskPreventiveActionAttachmentDropzone = new Dropzone("#task-preventive-action-form", appCreateDropzoneOptions({
        uploadMultiple: !0,
        clickable: "#dropzoneTaskPreventiveAction",
        previewsContainer: ".dropzone-task-preventive-action-previews",
        autoProcessQueue: !1,
        addRemoveLinks: !0,
        parallelUploads: 20,
        maxFiles: 20,
        paramName: "file",
        sending: function (e, t, a) {
            a.append("taskid", $("#addTaskPreventiveActionBtn").attr("data-preventive-task-id")), tinyMCE.activeEditor ? a.append("content", tinyMCE.activeEditor.getContent()) : a.append("content", $("#task_preventive_action").val())
        },
        success: function (e, t) {
            t = JSON.parse(t), 0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && (_task_append_html(t.taskHtml), tinymce.remove("#task_preventive_action"))
        }
    }));
    var t = _simple_editor_config();
    void 0 !== e && !1 !== e || (t.auto_focus = !0), is_ios() || init_editor("#task_preventive_action", t)
}
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
    ...
    side_bar.metisMenu(), setup_menu.metisMenu(), $(".hide-menu").click(function (e) {
        ...
        if ("" === t)
            return content_wrapper.unhighlight(), a.html(""), original_top_search_val = "", i.html('<i class="fa fa-search"></i>').removeClass("search_remove"), void e.addClass("display-block");
    ...
    if (i && $("#search_input").val(i).trigger("keyup"), $("body").on("blur", "#timesheet_duration", function () {
        ...
        if ((a = a.replace(t, "")).indexOf(":") > -1) {
            ...
            1 === a.length && -1 === a.indexOf(":") ? a = "0" + a + ":00" : a.length >= 2 && -1 === a.indexOf(":") && (a += ":00");
        a = "00:00" == a ? "" : a, e.val(a)
    ...
    }), $("body").on("click focus", "#task_root_cause", function (e) {
        init_new_task_root_cause();
    }), $("body").on("click focus", "#task_corrective_action", function (e) {
        init_new_task_corrective_action();
    }), $("body").on("click focus", "#task_preventive_action", function (e) {
        init_new_task_preventive_action();
        ...
        } else if (e.indexOf("#root_cause_") > -1) {
            var t = e.split("#root_cause_");
            t = t[t.length - 1], $('[data-task-root-cause-href-id="' + t + '"]').click()
        } else if (e.indexOf("#corrective_") > -1) {
            var t = e.split("#corrective_");
            t = t[t.length - 1], $('[data-task-corrective-href-id="' + t + '"]').click()
        } else if (e.indexOf("#preventive_") > -1) {
            var t = e.split("#preventive_");
            t = t[t.length - 1], $('[data-task-preventive-href-id="' + t + '"]').click()
        }
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', function () {
        ...
        if (n[1] && n[1].indexOf("=") > -1)
            if (s = !1, t = n[1].split("=")[1], n[1].indexOf("postid") > -1)
                postid = t, $(window).width() > 769 ? $(".open_newsfeed.desktop").click() : $(".open_newsfeed.mobile").click();
            else if (n[1].indexOf("taskid") > -1) {
                var o = void 0;
                if (i.indexOf("#comment_") > -1) {
                    var l = i.split("#comment_");
                    o = l[l.length - 1]
                } else if (i.indexOf("#root_cause_") > -1) {
                    var l = i.split("#root_cause_");
                    o = l[l.length - 1]
                }
                init_task_modal(t, o)
            } else
    ...
    }), init_table_tickets(), init_table_meter_number(), init_table_pmd_report(), init_table_full_report(), init_table_network_report(), init_table_trafic_road_safety_report(), init_table_paycity_report(), init_table_paycitySLA_report(), init_table_trafic_road_safetySLA_report(), init_table_networkSLA_report(), init_table_full_reportSLA_report(), init_table_unassigned_companies_report(), init_table_announcements(), init_table_staff_projects(), (table_activity_log = $("table.table-activity-log")).length) {
        var p = [];
    ...
    b.length > 0 && (b = b.sortable({
        ...
        requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done(function (e) {
            ...
            for (var n in billingAndShippingFields)
            ...
            for (var s in billingAndShippingFields)
