...
<div id="consent_data">
    <div class="row">
        ...
        <?php } ?>
                                        ...
                                        <br>
                                        <?php
                                        $time_resolve_per = $result['resolve_hours'] > 0 ? round($result['resolve_hours'] / $result['count_data']) : 0;
        ...
        <?php echo $time_resolve_per; ?>%
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <hr>
                                    <?php $total_ticket = 0; ?>
                            <?php foreach ($results_data as $data){ 
                                $total_ticket += $data->ticket_count;
                                ?>
