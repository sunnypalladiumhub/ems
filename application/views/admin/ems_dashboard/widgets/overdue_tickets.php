            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo admin_url('tickets?overdue'); ?>" class="pull-right mtop5">&nbsp;<?php echo _l('ems_dash_view_details'); ?></a>
                    </div>
                    <div class="col-md-12">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <?php $data_groups =  overdue_tickets_details((isset($customer_id) ? $customer_id : null),(isset($group_id) ? $group_id : null),(isset($departments_id) ? $departments_id : null),(isset($province) ? $province : null)); 
