...
<div class="modal fade" id="department" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('departments/email_add')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title">Edit Department email</span>
                    <span class="add-title">Add Department email</span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_select('departmentid',$departments,array('departmentid','name'),'ticket_settings_departments'); ?>
    ...
    <script>
        $(function(){
           initDataTable('.table-departments-email', window.location.href, [4], [4], undefined, [1, 'asc']);
        ...
        function edit_department(invoker,id){
            console.log($(invoker).data('departmentid'));
            var department_drp = $('#departmentid');
            department_drp.selectpicker('val',$(invoker).data('departmentid'));
            department_drp.selectpicker('refresh');
