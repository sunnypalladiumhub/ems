...
*
*/
//define('APP_BASE_URL', 'http://ems.119next.com/');
define('APP_BASE_URL', 'http://localhost/ems/');
...
*/
define('APP_ENC_KEY', '8ce06fdcd470c33b872af42ed9cb4455');

/**
 * Database Credentials
 * The hostname of your database server
 */
//define('APP_DB_HOSTNAME', 'dedi8.cpt3.host-h.net');
define('APP_DB_HOSTNAME', 'localhost');
/**
 * The username used to connect to the database
 */
//define('APP_DB_USERNAME', 'nextcwdmtm_10');
define('APP_DB_USERNAME', 'root');
/**
 * The password used to connect to the database
 */
//define('APP_DB_PASSWORD', 'f15jS6jwfXG97PU85UD8');
define('APP_DB_PASSWORD', '');
/**
 * The name of the database you want to connect to
 */
//define('APP_DB_NAME', 'EnerlyticsEMS_db10');
define('APP_DB_NAME', 'enerlyticsems_db10');
