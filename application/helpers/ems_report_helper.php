...
function get_ems_table_records(){
    ...
    $data['full_report'] = array(
        ...
        array('title'=>'Date Closed Date','field'=>'(select date from tbltickets_activity_log as tas where tas.ticket_id = tbltickets.ticketid AND tas.status_id IN(5) ORDER BY tas.date DESC LIMIT 1) as close_date'),
...
function get_pms_table_records(){
    $data = array();
    $data['pmd_report'] = array(
        array('title'=>'Service (Category)','field'=> 'IF('.db_prefix() .'services.parentid > 0, (SELECT name from tblservices as sub where sub.serviceid = tblservices.parentid), (SELECT name from tblservices as sub where sub.serviceid = tblservices.serviceid)) as parent_name'),
        array('title'=>'Date','field'=>'tbltickets.date as created_data'),
        array('title'=>'Ticket ID','field'=>'tbltickets.ticketid as ticketid'),
        array('title'=>'Meter number','field'=>'tblmeter_number.number as meter_number'),
        array('title'=>'Customer Contact Information - Full-name','field'=>'tbltickets.name as name'),
        array('title'=>'Customer Contact Information - Primary Address','field'=>'tbltickets.primary_address as primary_address'),
        array('title'=>'Customer Contact Information - Landline','field'=>'tbltickets.landline as landline'),
        array('title'=>'Customer Contact Information - Mobile','field'=>'tbltickets.mobile as mobile'),
        array('title'=>'Customer Contact Information - Province','field'=>'tbltickets.province as province'),
        array('title'=>'Description','field'=>'tbltickets.description as description'),
        array('title'=>'Sub Category','field'=>'IF('.db_prefix() .'services.parentid > 0, (SELECT name from tblservices as sub where sub.serviceid = tblservices.serviceid), "") as sub_parent_name'),
        array('title'=>'Subject','field'=>'tbltickets.subject as subject'),
        );
